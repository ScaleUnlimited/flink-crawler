...
public class SimpleUrlValidatorTest {
    ...
    public void testValidate() {
        ...
        assertFalse(validator.isValid("mailto:?Subject=http://info.foo.com/copyright/us/details.html"));
        ...
        assertFalse(validator.isValid("ttp://www.thehealthcareblog.com/the_health_care_blog/2009/07/healthcare-reform-lessons-from-mayo-clinic.html"));
   }
