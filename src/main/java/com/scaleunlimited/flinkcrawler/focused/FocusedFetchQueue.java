 ...
 * 
 * FUTURE - when add() is called for the first N, calculate percentile bucket boundaries and cache the URLs. Once we
 * have confidence in the distribution, archive any in the lowest quartile, add any in the highest quartile, and do
 * something interesting :) with the ones in the middle.
 *
 */
