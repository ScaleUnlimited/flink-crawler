...
public class FetchUtils {
    ...
    /**
     * @param maxSimultaneousRequests for the fetcher that the builder will construct
     ...
     */
    public static SimpleHttpFetcherBuilder makeRedirectFetcherBuilder(int maxSimultaneousRequests, UserAgent userAgent) {
        SimpleHttpFetcherBuilder builder = new SimpleHttpFetcherBuilder(maxSimultaneousRequests, userAgent);
