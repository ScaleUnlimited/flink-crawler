 ...
 * 
 * See https://github.com/iipc/warc-specifications/blob/gh-pages/specifications/warc-format/warc-1.1/index.md
 * for the actual WARC spec.
 */
public class WarcRecord {
	...
	private static final String LINE_ENDING = new String(new byte[] {CR_BYTE, LF_BYTE}, StandardCharsets.UTF_8);
