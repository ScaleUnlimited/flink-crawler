...
public class CounterUtils {
    ...
    public static void decrement(RuntimeContext runtimeContext, Enum<?> e) {
    ...
    public static long getCounterValue(RuntimeContext runtimeContext, String group,
            String counter) {
        if (runtimeContext != null) {
            return getOrInitCounter(runtimeContext, mergeGroupCounter(group, counter))
                    .getLocalValue();
        } else {
            return 0L;
        }
