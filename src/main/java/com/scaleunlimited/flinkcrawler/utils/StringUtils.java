...
public class StringUtils {
    ...
    /**
     * Get a text representation of a byte[] as hexadecimal String, where each pair of hexadecimal digits corresponds to
     * consecutive bytes in the array.
     * 
     * @param buf
     *            input data
     * @param sep
     *            separate every pair of hexadecimal digits with this separator, or null if no separation is needed.
     * @param lineLen
     *            break the output String into lines containing output for lineLen bytes.
     */
    ...
    /**
     * Convert a String containing consecutive (no inside whitespace) hexadecimal digits into a corresponding byte
     * array. If the number of digits is not even, a '0' will be appended in the front of the String prior to
