...
public class CreateWARCWritableFunction extends BaseFlatMapFunction<ParsedUrl, Tuple2<NullWritable, WARCWritable>> {
    ...
    @Override
    public void flatMap(ParsedUrl parsedUrl, Collector<Tuple2<NullWritable, WARCWritable>> collector)
            throws Exception {
        
        // TODO - fill in the actual warc info here
        String parsedText = parsedUrl.getParsedText();
        
        StringBuffer content = new StringBuffer();

        content.append(String.format("url: %s\r\n", parsedUrl.getUrl())); // TODO verify if this field is correct 
