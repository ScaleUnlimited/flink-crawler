 ...
 * hash, value = CrawlStateUrl. Whenever we get a "tickler" URL, we emit URLs from the fetch queue (if available).
 * Whenever we get a "domain" URL, we add URLs for that domain to the fetch queue.
 * 
